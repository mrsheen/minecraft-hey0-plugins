...
jar cvf export/Stats.jar MANIFEST.MF -C build/classes Stats.class -C build/classes Stats\$1.class -C build/classes StatsHandler.class -C build/classes StatsFormatter.class
